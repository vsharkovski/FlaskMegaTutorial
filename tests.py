...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_posts(self):
        # create 4 users
        u1 = User(username="john", email="j@example.com")
        u2 = User(username="susan", email="s@example.com")
        u3 = User(username="mary", email="m@example.com")
        u4 = User(username="david", email="d@example.com")
